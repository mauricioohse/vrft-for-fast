...
load_filename=strcat(cell2mat(plot_filenames(4)),'ctrl_step');
load(load_filename)
figure(1)
subplot(2,1,1)
hold on
...
subplot(2,1,1)
xlim([0 30])
legend('C_b','Td C_b','C_1','Td C_1','C_2','Td C_2','C_2','Td C_2','C_3','Td C_3')
...
load_filename=strcat(cell2mat(plot_filenames(4)),'f1625');
load(load_filename)
figure(8)
subplot(3,1,1)
hold on
